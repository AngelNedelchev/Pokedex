/*==================================================================================================
        ...
        function DoThingsWithTheDom() {
            ...
            */
            ...
            document.getElementById("picture").src = pokemon_image;
            document.getElementById("orange-one").innerHTML  = pokemon_name;
            document.getElementById("number").innerHTML = pokemon_id;
            document.getElementById("infobox").innerHTML = "Weight: " + pokemon_weight/10 + " kg" + "<br/>" 
            + "Abilities: " + pokemon_abilities + "<br/>" 
            + "Moves: " + pokemon_moves[Math.floor(Math.random() * pokemon_moves.length)] 
            + "      " + pokemon_moves[Math.floor(Math.random() * pokemon_moves.length)]
